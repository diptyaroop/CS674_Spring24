...
if __name__ == "__main__":
    ...
    if firstMethod == "nerf":
        #os.system("cd nerf")
        os.system(f"python3 nerf/run.py --config configs/nerf/{dataset}.py --render_test --dump_images --i_print 500")
        #Then run style transfer
        os.system(f"python3 st/test.py --contentdir ../logs/nerf_synthetic/{dataset} --output ../logs/nerf_synthetic/{dataset}_final")
        #if sys.argv[3] == "eval":
        #    os.system("eval_metrics.py")
    elif firstMethod == "st":
        #run style transfer
        os.system(f"python3 st/test.py --contentdir ../data/nerf_synthetic/{dataset} --output ../data/nerf_synthetic/{dataset}_st")
        #if sys.argv[3] == "eval":
        #    os.system("eval_metrics.py")
        os.system(f"python3 nerf/run.py --config configs/nerf/{dataset}.py --render_test --dump_images --i_print 500")
    else:
    ...
    os.system(f"python3 scripts/stitchImagesToVideo.py {inputPath}")
